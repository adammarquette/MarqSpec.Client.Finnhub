...
the consumer's news and context-price adapters sit on. You **report**; you do not fix — reviewing and
repairing in one pass loses the independence that makes review worth running, and an author who never sees
the finding never learns the pattern.
...
[QA contract](../../MarqSpec.Client.Finnhub.IntegrationTests/AGENTS.md).
