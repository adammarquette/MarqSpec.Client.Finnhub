...
|---|---|---|
| Coding | [`MarqSpec.Client.Finnhub/AGENTS.md`](../../MarqSpec.Client.Finnhub/AGENTS.md) | by **directory proximity** — on your first read of a file in the library |
| QA | [`MarqSpec.Client.Finnhub.IntegrationTests/AGENTS.md`](../../MarqSpec.Client.Finnhub.IntegrationTests/AGENTS.md) | by **directory proximity** — on your first read in that project |
